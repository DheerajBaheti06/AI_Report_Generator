...
// --- ICON COMPONENTS ---
const IconRefresh = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>;
const IconUndo = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12.5 8c-2.65 0-5.05.99-6.9 2.6L2 7v9h9l-3.62-3.62c1.39-1.16 3.16-1.88 5.12-1.88 3.54 0 6.55 2.31 7.6 5.5l2.37-.78C21.08 11.03 17.15 8 12.5 8z"/></svg>;
const IconRedo = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M18.4 10.6C16.55 8.99 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22L3.9 16c1.05-3.19 4.05-5.5 7.6-5.5 1.96 0 3.73.72 5.12 1.88L13 16h9V7l-3.6 3.6z"/></svg>;
const IconFileDoc = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zM13 9V3.5L18.5 9H13z"/></svg>;
const IconFilePdf = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8.5 7.5c0 .83-.67 1.5-1.5 1.5H9v2H7.5V7H10c.83 0 1.5.67 1.5 1.5v1zm-2.5.5h1v-1h-1v1zm7-1.5H14v6h1.5v-2h1.1c.83 0 1.5-.67 1.5-1.5v-1c0-.83-.67-1.5-1.5-1.5zm.9 2.5h-1v-1h1v1zM4 6H2v14c0 1.1.9 2 2 2h14v-2-H4V6z"/></svg>;
const IconTypography = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M2.5 4v3h5v12h3V7h5V4h-13zm19 5h-9v3h3v7h3v-7h3V9z"></path></svg>;
const IconPageSetup = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M6 2c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2H6zm0 2h12v3H6V4zm0 5h12v11H6V9z"></path></svg>;
const IconHeaderFooter = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M4 20h16v2H4v-2zM4 2h16v2H4V2zm11 5H9v11h6V7zm-2 9h-2V9h2v7z"></path></svg>;
const IconExport = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"></path></svg>;
const IconZoomIn = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path></svg>;
const IconPageBreak = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M19 9h-3V5h-2v4H8l4 4 4-4zM4 18h16v-2H4v2zm0-7h16v-2H4v2z"/></svg>;
const IconZoomOut: React.FC = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13H5v-2h14v2z"></path></svg>;
const IconAlignLeft = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M15 15H3v2h12v-2zm0-8H3v2h12V7zM3 13h18v-2H3v2zm0 8h18v-2H3v2zM3 3v2h18V3H3z"></path></svg>;
const IconAlignCenter = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M7 15v2h10v-2H7zm-4 6h18v-2H3v2zm0-8h18v-2H3v2zm4-6v2h10V7H7zM3 3v2h18V3H3z"></path></svg>;
const IconAlignRight = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M3 21h18v-2H3v2zm6-4h12v-2H9v2zm-6-4h18v-2H3v2zm6-4h12V7H9v2zM3 3v2h18V3H3z"></path></svg>;
const IconAlignJustify = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M3 21h18v-2H3v2zm0-4h18v-2H3v2zm0-4h18v-2H3v2zm0-4h18V7H3v2zm0-4h18V3H3v2z"></path></svg>;
const IconSun = ({ className }: { className?: string }) => <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg>;
const IconMoon = ({ className }: { className?: string }) => <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>;
const IconUser = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 6c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2m0 10c2.7 0 5.8 1.29 6 2H6c.23-.72 3.31-2 6-2M12 4C9.79 4 8 5.79 8 8s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 9c-2.67 0-8 1.34-8 4v3h16v-3c0-2.66-5.33-4-8-4z"></path></svg>;
const IconLinkedIn = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14zm-11.5 15h2.5V10h-2.5v8zm-1.25-9.25c0 .69.56 1.25 1.25 1.25s1.25-.56 1.25-1.25S8.94 7.5 8.25 7.5 7 8.06 7 8.75zM17 18h-2.5v-4.5c0-1.07-.02-2.44-1.5-2.44s-1.73 1.16-1.73 2.37V18h-2.5V10h2.4v1.1h.03c.34-.64 1.18-1.32 2.37-1.32 2.54 0 3 1.67 3 3.84V18z"></path></svg>;
const IconGitHub = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1.27a11 11 0 00-3.48 21.46c.55.1.73-.24.73-.53v-1.84c-3.03.66-3.67-1.46-3.67-1.46-.5-1.27-1.22-1.61-1.22-1.61-1-.68.08-.67.08-.67 1.1.08 1.68 1.13 1.68 1.13.98 1.68 2.56 1.2 3.18.92.1-.72.38-1.2.7-1.48-2.42-.28-4.96-1.2-4.96-5.38 0-1.19.42-2.16 1.13-2.92-.1-.28-.49-1.38.1-2.88 0 0 .92-.3 3 1.12a10.4 10.4 0 015.4 0c2.08-1.42 3-1.12 3-1.12.6 1.5.2 2.6.1 2.88.7.76 1.13 1.73 1.13 2.92 0 4.2-2.55 5.1-4.98 5.38.4.34.73.98.73 1.98v2.92c0 .3.18.63.73.53A11 11 0 0012 1.27z"></path></svg>;
const IconCopy = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"></path></svg>;
const IconExternalLink = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"></path></svg>;
...
}>(({ onClick, disabled, title, children, className = '', type = "button" }, ref) => (
    <button ref={ref} type={type} className={`icon-button ${className}`} onClick={onClick} disabled={disabled} title={title} aria-label={title}>
        {children}
    </button>
));
...
const FloatingToolbar = React.forwardRef<HTMLDivElement, FloatingToolbarProps>(({ targetElement, block, onStyleChange, onApplyStyleToAll, onPageBreakToggle }, ref) => {
    ...
    React.useLayoutEffect(() => {
        ...
        const updatePosition = () => {
            if (!targetElement || !toolbarEl || !container || !document.contains(targetElement)) {
                setIsVisible(false);
                cancelHideTimer();
                return;
            }
            ...
            const idealLeft = (targetRect.left - containerRect.left + scrollLeft) + (targetRect.width / 2) - (toolbarWidth / 2);
            ...
            if (spaceAboveInViewport >= (toolbarHeight + margin)) {
                idealTop = (targetRect.top - containerRect.top + scrollTop) - toolbarHeight - margin;
            } else {
                    ...
                    {isTextBasedBlock && (
                        <>
                            ...
                            <button
                                ...
                                onClick={() => onStyleChange(block.id, { bold: !block.style.bold })}
                                title="Bold"
                            >
                                <b>B</b>
                            </button>
                            <button onClick={() => onStyleChange(block.id, { fontSize: `${parseInt(block.style.fontSize) - 1}px` })} title="Decrease font size">-</button>
                            <span>{block.style.fontSize}</span>
                            <button onClick={() => onStyleChange(block.id, { fontSize: `${parseInt(block.style.fontSize) + 1}px` })} title="Increase font size">+</button>
                        </>
                    )}
                    <button
                        className={`page-break-btn ${block.pageBreakBefore ? 'active' : ''}`}
                        onClick={() => onPageBreakToggle(block.id)}
                        title={block.pageBreakBefore ? "Remove page break" : "Insert page break before"}
                    >
                        <IconPageBreak />
                    </button>
                    {isTextBasedBlock && (
                         <>
                            <button className="apply-all" onClick={() => onApplyStyleToAll(block)} title="Apply style to all similar elements">
                                Apply to All
                            </button>
                         </>
                    )}
...
const MobilePanel: React.FC<{
    ...
    return (
        <div className="mobile-format-panel-overlay" onClick={onClose}>
            <div className={`mobile-format-panel ${panel ? 'open' : ''}`} onClick={e => e.stopPropagation()}>
...
const ReportDisplay: React.FC<{
    ...
    return (
        <div className="pages-container-wrapper">
            ...
            />
            <div className="pages-container" style={{ transform: `scale(${zoomLevel / 100})`, transformOrigin: 'top left' }}>
                {paginatedReport.map((page, pageIndex) => (
                    <div key={pageIndex} className={`output-page ${formattingOptions.showBorders ? 'has-border' : ''}`} data-document-theme={formattingOptions.theme} style={{
                        paddingLeft: formattingOptions.margin,
                        paddingRight: formattingOptions.margin,
                        '--page-margin': formattingOptions.margin,
                    } as React.CSSProperties}>
                        <div className="page-header-preview" style={{ paddingLeft: formattingOptions.margin, paddingRight: formattingOptions.margin }}>
                            {formattingOptions.header}
                        </div>
                        <div className="report-display" style={{
                            ...
                            {page.map(block => (
                                <EditableBlock
                                    ...
                                    onFocus={(id, el) => { setSelectedBlockId(id); setSelectedElement(el); }}
                                />
                            ))}
                        </div>
                        <div className="page-footer-preview" style={{ paddingLeft: formattingOptions.margin, paddingRight: formattingOptions.margin }}>
                            <span>{formattingOptions.footer}</span>
                            {formattingOptions.showPageNumbers && <span>{pageIndex + 1}</span>}
                        </div>
                    </div>
                ))}
            </div>
...
const ContactPopover: React.FC<{ isOpen: boolean; onClose: () => void; anchorRef: React.RefObject<HTMLButtonElement>; }> = ({ isOpen, onClose, anchorRef }) => {
    const [copiedLink, setCopiedLink] = React.useState<'linkedin' | 'github' | null>(null);
    ...
    React.useLayoutEffect(() => {
        if (isOpen && anchorRef.current && popoverRef.current) {
            ...
            const leftPosition = anchorRect.left + (anchorRect.width / 2) - (popoverWidth / 2);
            
            const clampedLeft = Math.max(16, Math.min(leftPosition, window.innerWidth - popoverWidth - 16));
    ...
    React.useEffect(() => {
        ...
        const handleClickOutside = (event: MouseEvent) => {
            if (popoverRef.current && !popoverRef.current.contains(event.target as Node) && !anchorRef.current?.contains(event.target as Node)) {
                onClose();
            }
        };
            ...
            <div className="popover-body">
                <div className="popover-link-row">
                    ...
                    <div className="popover-link-info">
                        <span>LinkedIn</span>
                        <a href={LINKEDIN_LINK} target="_blank" rel="noopener noreferrer">in/dheeraj-baheti1</a>
                    </div>
                    <div className="popover-actions">
                        <IconButton onClick={() => handleCopy(LINKEDIN_LINK, 'linkedin')} title="Copy Link">
                            {copiedLink === 'linkedin' ? '✓' : <IconCopy />}
                        </IconButton>
                        <a href={LINKEDIN_LINK} target="_blank" rel="noopener noreferrer">
                           <IconButton onClick={() => {}} title="View Profile"><IconExternalLink /></IconButton>
                        </a>
                    </div>
                </div>
                <div className="popover-link-row">
                    ...
                    <div className="popover-link-info">
                        <span>GitHub</span>
                        <a href={GITHUB_LINK} target="_blank" rel="noopener noreferrer">DheerajBaheti06</a>
                    </div>
                     <div className="popover-actions">
                        <IconButton onClick={() => handleCopy(GITHUB_LINK, 'github')} title="Copy Link">
...
const App = () => {
    ...
    const [formattingOptions, setFormattingOptions] = React.useState<FormattingOptions>({
        fontSize: '16px',
        fontFamily: 'Arial',
        lineSpacing: '1.5',
        textAlign: 'left',
    ...
    const [activeTab, setActiveTab] = React.useState<'generate' | 'preview'>('generate');
    const [history, setHistory] = React.useState<HistoryEntry[]>([]);
    const [historyIndex, setHistoryIndex] = React.useState(-1);
    const [selectedBlockId, setSelectedBlockId] = React.useState<string | null>(null);
    const [selectedElement, setSelectedElement] = React.useState<HTMLElement | null>(null);
    const [zoomLevel, setZoomLevel] = React.useState(100);
    const [isThinkingModeEnabled, setIsThinkingModeEnabled] = React.useState(false);
    const [mobilePanel, setMobilePanel] = React.useState<null | 'format' | 'header' | 'export'>(null);
    const [paginatedReport, setPaginatedReport] = React.useState<ReportBlock[][]>([]);
    const [exportMessage, setExportMessage] = React.useState('');
    const [isMobileView, setIsMobileView] = React.useState(window.innerWidth <= 900);
    ...
    const [originalFormattingBeforeFit, setOriginalFormattingBeforeFit] = React.useState<FormattingOptions | null>(null);
    const [originalBlocksBeforeFit, setOriginalBlocksBeforeFit] = React.useState<ReportBlock[] | null>(null);
    ...
    React.useEffect(() => {
        if (!API_KEY) {
            const errorMessage = "API_KEY environment variable not set. Please follow the setup instructions in the README file to configure your API key.";
    ...
    React.useEffect(() => {
        const calculatePages = async () => {
            ...
            const measuredWrappers = Array.from(measurementContainer.querySelectorAll('.editable-block-wrapper')) as HTMLElement[];
            ...
            reportBlocks.forEach((block, index) => {
                ...
                if (currentHeight + elementHeight > PAGE_CONTENT_HEIGHT_PX && currentPage.length > 0) {
                    pages.push(currentPage);
                    currentPage = [block];
    ...
    const updateHistory = React.useCallback((newReport: ReportBlock[], newFormatting: FormattingOptions) => {
    ...
    React.useEffect(() => {
        ...
        if (currentPageCount > targetPageCount) {
            ...
            if (currentGlobalFontSize <= 10) {
                ...
                setAutoFitMessage(`Content is too long to fit into ${targetPageCount} pages. We've made it as compact as possible.`);
            ...
            setNeedsAutoFit(false);
            if (originalFormattingBeforeFit && originalFormattingBeforeFit.fontSize !== formattingOptions.fontSize) {
                setAutoFitMessage(`✨ Auto-Fit Applied: Your report has been formatted to fit ${targetPageCount} pages.`);
            }
            updateHistory(reportBlocks, formattingOptions);
        }

    }, [paginatedReport, needsAutoFit, formattingOptions, numberOfPages, status, reportBlocks, originalFormattingBeforeFit, updateHistory]);
    ...
    const adjustZoomToFit = React.useCallback(() => {
        if (isMobileView) {
            ...
            if (previewContainer) {
                 const pageContainer = previewContainer.querySelector('.pages-container-wrapper');
                 if (pageContainer) {
                     const containerWidth = previewContainer.clientWidth;
                     const contentWidth = pageContainer.clientWidth;
                     const scaledContentWidth = contentWidth * 0.30;
        ...
        if (previewContainer && pageContainer) {
            ...
            if (contentWidth > 0 && contentHeight > 0) {
                ...
                previewContainer.scrollLeft = (scaledContentWidth - containerWidth) / 2;
                previewContainer.scrollTop = (scaledContentHeight - containerHeight) / 2;
            }
        }
    }, [isMobileView]);
    ...
    React.useEffect(() => {
        const canvas = isMobileView ? mobilePreviewRef.current : desktopPreviewRef.current;
        ...
        const handlePanStart = (clientX: number, clientY: number, target: EventTarget | null) => {
        ...
        const onMouseDown = (e: MouseEvent) => handlePanStart(e.clientX, e.clientY, e.target);
        ...
        const onTouchMove = (e: TouchEvent) => {
            ...
            } else if (e.touches.length === 2 && initialDistance !== null && initialZoom !== null) {
                e.preventDefault();
                const touch1 = e.touches[0];
                const touch2 = e.touches[1];
    ...
    const handleGenerateReport = async () => {
        if (!ai) {
            setError("Cannot generate report: AI service is not initialized. Check your API key configuration in your environment variables.");
            setStatus('error');
            return;
        }
        if (!reportTopic) {
...
**FINAL REMINDER: The word count limit of ${wordCount} words is NOT a suggestion. It is a strict rule. Do not fail.**`;
        ...
        try {
            const modelName = isThinkingModeEnabled ? 'gemini-2.5-pro' : 'gemini-2.5-flash';
            const config: any = {
            ...
            const themeColor = THEME_DEFAULT_COLORS[formattingOptions.theme as keyof typeof THEME_DEFAULT_COLORS] || THEME_DEFAULT_COLORS.default;
            const baseStyle = { fontSize: formattingOptions.fontSize, fontFamily: formattingOptions.fontFamily, color: themeColor, bold: false };
    
            const newReport: ReportBlock[] = parsedResponse.report.map((block: any) => {
                let style = { ...baseStyle };
            ...
            if (err instanceof SyntaxError) {
                errorMessage = 'The AI returned an invalid format. Please try regenerating.';
    ...
    // --- STYLING & EDITING ---
     const handleGlobalFormatChange = (option: keyof FormattingOptions, value: any) => {
        setAutoFitMessage('');
        ...
        if (option === 'theme') {
            const oldDefaultColor = THEME_DEFAULT_COLORS[oldFormatting.theme as keyof typeof THEME_DEFAULT_COLORS] || THEME_DEFAULT_COLORS.default;
            const newDefaultColor = THEME_DEFAULT_COLORS[value as keyof typeof THEME_DEFAULT_COLORS] || THEME_DEFAULT_COLORS.default;
    ...
    const handleBlockUpdate = (id: string, newText: string) => {
        const newReport = reportBlocks.map(b => b.id === id ? { ...b, text: newText.replace(/^• |^\d+\. /, '') } : b);
        setReportBlocks(newReport);
    ...
    const exportToPDF = async () => {
        ...
        try {
            ...
            const allPageElements = Array.from(document.querySelectorAll('.output-page')) as HTMLElement[];
            const visiblePageElements = allPageElements.filter(el => el.offsetParent !== null);
            ...
            for (let i = 0; i < visiblePageElements.length; i++) {
                ...
                try {
                    ...
                    doc.addImage(imgData, 'PNG', 0, 0, PAGE_WIDTH_IN, PAGE_HEIGHT_IN, undefined, 'FAST');
                } finally {
    ...
    const exportToDocx = async () => {
        ...
        try {
            const { Document, Packer, Paragraph, TextRun, AlignmentType, HeadingLevel, Header, Footer, PageNumber, ImageRun, BorderStyle, PageBorderDisplay } = await import('docx');
            ...
            const childrenPromises = reportBlocks.map(async (block) => {
                if (block.type === 'image') {
                    ...
                    const paragraphConfig: any = {
                        ...
                        spacing: { line: Math.round(parseFloat(formattingOptions.lineSpacing) * 240) },
                    ...
                    switch (block.type) {
                        case 'heading1':
                            paragraphConfig.spacing.before = pointsToTwips(fontSizeInPoints * 1.5);
                            paragraphConfig.spacing.after = pointsToTwips(fontSizeInPoints * 0.4);
                            break;
                        case 'heading2':
                            paragraphConfig.spacing.before = pointsToTwips(fontSizeInPoints * 1.2);
                            paragraphConfig.spacing.after = pointsToTwips(fontSizeInPoints * 0.4);
                            break;
                        case 'heading3':
                            paragraphConfig.spacing.before = pointsToTwips(fontSizeInPoints * 1.0);
                            paragraphConfig.spacing.after = pointsToTwips(fontSizeInPoints * 0.4);
                            break;
                        case 'paragraph':
                            paragraphConfig.spacing.after = pointsToTwips(fontSizeInPoints * 0.5);
                            break;
                        case 'bullet':
                        case 'numbered':
                             paragraphConfig.spacing.after = pointsToTwips(fontSizeInPoints * 0.2);
                             break;
                    }

                    if (block.type.startsWith('heading')) {
                        paragraphConfig.heading = HeadingLevel[`HEADING_${block.type.slice(-1)}` as 'HEADING_1' | 'HEADING_2' | 'HEADING_3'];
                    }
                    if (block.type === 'bullet') paragraphConfig.bullet = { level: 0 };
                    if (block.type === 'numbered') paragraphConfig.numbering = { reference: "my-numbering", level: 0 };
            ...
            const sectionConfig: any = {
                 headers: {
                    default: new Header({
                        children: [new Paragraph({ text: formattingOptions.header, alignment: AlignmentType.CENTER })],
                    }),
                },
                footers: {
                     default: new Footer({
                        children: [new Paragraph({
                            ...
                            children: [
                                ...
                                ...(formattingOptions.showPageNumbers ? [new TextRun({ children: [PageNumber.CURRENT] })] : []),
                            ],
                        })],
                    }),
                },
    ...
    const formattingPanelContent = (
        <>
            <div className="input-group">
                ...
                <select id="font-family" value={formattingOptions.fontFamily} onChange={e => handleGlobalFormatChange('fontFamily', e.target.value)}>
            ...
            <div className="inline-inputs">
                <div className="input-group">
                    ...
                    <input type="text" id="font-size" value={formattingOptions.fontSize} onChange={e => handleGlobalFormatChange('fontSize', e.target.value)} />
                </div>
                <div className="input-group">
                    <label htmlFor="line-spacing">Line Spacing</label>
                    <select id="line-spacing" value={formattingOptions.lineSpacing} onChange={e => handleGlobalFormatChange('lineSpacing', e.target.value)}>
            ...
            <div className="input-group">
                ...
                <div className="action-group button-group">
                    <IconButton className={formattingOptions.textAlign === 'left' ? 'active' : ''} onClick={() => handleGlobalFormatChange('textAlign', 'left')} title="Align Left"><IconAlignLeft /></IconButton>
                    <IconButton className={formattingOptions.textAlign === 'center' ? 'active' : ''} onClick={() => handleGlobalFormatChange('textAlign', 'center')} title="Align Center"><IconAlignCenter /></IconButton>
                    <IconButton className={formattingOptions.textAlign === 'right' ? 'active' : ''} onClick={() => handleGlobalFormatChange('textAlign', 'right')} title="Align Right"><IconAlignRight /></IconButton>
                    <IconButton className={formattingOptions.textAlign === 'justify' ? 'active' : ''} onClick={() => handleGlobalFormatChange('textAlign', 'justify')} title="Align Justify"><IconAlignJustify /></IconButton>
                </div>
            </div>
            <div className="input-group">
                <label htmlFor="doc-theme">Document Theme</label>
                <select id="doc-theme" value={formattingOptions.theme} onChange={e => handleGlobalFormatChange('theme', e.target.value)}>
            ...
            <div className="input-group-inline checkbox-group">
                <input id="show-borders" type="checkbox" checked={formattingOptions.showBorders} onChange={e => handleGlobalFormatChange('showBorders', e.target.checked)} />
    ...
    const headerFooterPanelContent = (
         <div className="sidebar-section-content">
            <div className="input-group">
                ...
                <input type="text" id="header-text" value={formattingOptions.header} onChange={e => handleGlobalFormatChange('header', e.target.value)} />
            </div>
            <div className="input-group">
                <label htmlFor="footer-text">Footer Text</label>
                <input type="text" id="footer-text" value={formattingOptions.footer} onChange={e => handleGlobalFormatChange('footer', e.target.value)} />
            </div>
            <div className="input-group-inline checkbox-group">
                <input id="show-page-numbers" type="checkbox" checked={formattingOptions.showPageNumbers} onChange={e => handleGlobalFormatChange('showPageNumbers', e.target.checked)} />
    ...
    const exportPanelContent = (
        <div className="sidebar-section-content">
            <button className="action-button export-button-panel" onClick={() => handleExportRequest('docx')} disabled={!!exportMessage}>
                <IconFileDoc /> <span>Export to DOCX</span>
            </button>
             <button className="action-button export-button-panel" onClick={() => handleExportRequest('pdf')} disabled={!!exportMessage}>
                <IconFilePdf /> <span>Export to PDF</span>
            </button>
            {exportMessage && <div className={`status-message small ${exportMessage.toLowerCase().includes('failed') ? 'error' : ''}`}>{exportMessage}</div>}
        </div>
    );

    const renderPreview = () => {
        if (status === 'loading') {
            return <div className="status-message"><div className="loader"></div><p>Generating your report...</p></div>;
        }
        if (status === 'error' && reportBlocks.length === 0) {
            return <div className="status-message"><p className="error-message">{error}</p></div>;
        }
        if (reportBlocks.length === 0) {
            return <div className="status-message"><p>Generate a report to see a preview here.</p></div>;
        }
                ...
                <div className="desktop-layout">
                    <div className="preview-sidebar">
                        <details open className="sidebar-section">
                            ...
                            <div className="sidebar-section-content">{formattingPanelContent}</div>
                        </details>
                    ...
                    <div className="preview-main-area">
                        {autoFitMessage && (
                            <div className="autofit-notification">
                                ...
                                {originalFormattingBeforeFit && <button onClick={handleRevertAutoFit}>Revert</button>}
                            </div>
                        )}
                        <div className="preview-top-bar">
                             ...
                             <div className="top-bar-group">
                                <IconButton onClick={handleUndo} disabled={historyIndex <= 0} title="Undo"><IconUndo /></IconButton>
                                <IconButton onClick={handleRedo} disabled={historyIndex >= history.length - 1} title="Redo"><IconRedo /></IconButton>
                             </div>
                             <div className="top-bar-group">
                                 <div className="zoom-controls">
                                     <IconButton onClick={() => handleZoomButtonClick(-10)} title="Zoom Out"><IconZoomOut /></IconButton>
                                     <div className="zoom-display" onClick={adjustZoomToFit} title="Fit to screen">{zoomLevel}%</div>
                                     <IconButton onClick={() => handleZoomButtonClick(10)} title="Zoom In"><IconZoomIn /></IconButton>
                                 </div>
                             </div>
                             <div className="top-bar-group">
                                <IconButton onClick={() => handleExportRequest('docx')} disabled={!!exportMessage} title="Export to DOCX"><IconFileDoc /></IconButton>
                                <IconButton onClick={() => handleExportRequest('pdf')} disabled={!!exportMessage} title="Export to PDF"><IconFilePdf /></IconButton>
                                {exportMessage && <span className={`export-status-message ${exportMessage.toLowerCase().includes('failed') ? 'error' : ''}`}>{exportMessage}</span>}
                            </div>
                             <div className="top-bar-group">
                                <IconButton onClick={() => { setStatus('idle'); setActiveTab('generate'); }} title="Regenerate Report">
                                    <IconRefresh />
                                </IconButton>
                             </div>
                        </div>
                ...
                <div className="mobile-layout">
                    ...
                    <div className="mobile-preview-header">
                        ...
                        <div className="action-group">
                             ...
                             <IconButton onClick={handleUndo} disabled={historyIndex <= 0} title="Undo"><IconUndo /></IconButton>
                             <IconButton onClick={handleRedo} disabled={historyIndex >= history.length - 1} title="Redo"><IconRedo /></IconButton>
                             <IconButton onClick={() => { setStatus('idle'); setActiveTab('generate'); }} title="Regenerate Report"><IconRefresh /></IconButton>
                        </div>
                    </div>
                     ...
                     <div className="mobile-preview-footer">
                         <button onClick={() => setMobilePanel('format')} className={mobilePanel === 'format' ? 'active' : ''}>
                             <IconTypography />
                             <span>Format</span>
                         </button>
                         <button onClick={() => setMobilePanel('header')} className={mobilePanel === 'header' ? 'active' : ''}>
                             <IconHeaderFooter />
                              <span>Header</span>
                         </button>
                         <button onClick={() => setMobilePanel('export')} className={mobilePanel === 'export' ? 'active' : ''}>
                              <IconExport />
                              <span>Export</span>
                         </button>
                     </div>
                     <MobilePanel panel={mobilePanel} onClose={() => setMobilePanel(null)} title={
                         mobilePanel === 'format' ? 'Formatting' :
                         mobilePanel === 'header' ? 'Header & Footer' : 'Export'
                     }>
    ...
    return (
        <div className={`app-container ${activeTab === 'preview' ? '' : 'constrained-width'}`}>
            <header>
                 ...
                 <div className="header-actions">
                    <div className="header-button-stack">
                        ...
                        <IconButton 
                            ...
                            title="Contact Info" 
                            className={`contact-button ${isContactPopoverOpen ? 'active' : ''}`}
                        >
                            <IconUser />
                        </IconButton>
                    </div>
            ...
            <main className="main-content">
                <nav className="tabs-nav">
                    ...
                    <button className={`tab-button ${activeTab === 'preview' ? 'active' : ''}`} onClick={() => setActiveTab('preview')} disabled={reportBlocks.length === 0 && !error}>
                        Preview & Edit
                    </button>
                </nav>
                ...
                {activeTab === 'generate' && (
                    <div className="controls-card">
                        ...
                        <div className="info-section">
                            <h4>How It Works</h4>
                            <p>
                                The AI will generate a report aiming for your target page count by estimating about <strong>450 words per page</strong>. 
                                After generation, you can use the <strong>Auto-Fit</strong> feature in the preview tab to fine-tune the formatting to match the page count precisely.
                            </p>
                        </div>
                        
                        <div className="input-group-inline checkbox-group thinking-mode-group">
                           <input id="thinking-mode" type="checkbox" checked={isThinkingModeEnabled} onChange={e => setIsThinkingModeEnabled(e.target.checked)} />
                            <label htmlFor="thinking-mode">
                                Enable High-Quality Mode
                                <span className="subtle-text"> (Uses Gemini 2.5 Pro for more detailed reports, may take longer)</span>
                           </label>
                        </div>

                        {status === 'error' && <p className="error-message">{error}</p>}
                        
                        <button className="generate-button" onClick={handleGenerateReport} disabled={status === 'loading' || !API_KEY}>
